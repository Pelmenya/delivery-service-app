export const ERRORS = {
    ...
    NOT_EXIST_ADVERTISEMENT: 'Объявления не существует!',
    NOT_EXIST_USER: 'Пользователя не существует!',
    ADVERTISEMENT_HAS_BEEN_DELETED: 'Объявление уже было удалено Вами или с Вашего аккаунта!',
    NEED_TO_AUTH: 'Необходима авторизация',
